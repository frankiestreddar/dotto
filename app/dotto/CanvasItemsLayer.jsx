...
const CARD_KIND_COMPONENTS = { checklist: ChecklistCard, embed: EmbedCard, flashcard: FlashcardCard, note: NoteCard, statcard: StatcardCard, stopwatch: StopwatchCard, title: TitleCard, watermark: WatermarkCard };
