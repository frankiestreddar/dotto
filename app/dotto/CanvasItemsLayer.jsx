...
const CARD_KIND_COMPONENTS = { checklist: ChecklistCard, embed: EmbedCard, flashcard: FlashcardCard, folder: CanvasCard, note: NoteCard, source: SourceCard, statcard: StatcardCard, stopwatch: StopwatchCard, table: TableCard, title: TitleCard, typeright: TypeRightCard, watermark: WatermarkCard };
