...
const CARD_KIND_COMPONENTS = { checklist: ChecklistCard, embed: EmbedCard, note: NoteCard, statcard: StatcardCard, stopwatch: StopwatchCard, title: TitleCard, watermark: WatermarkCard };
