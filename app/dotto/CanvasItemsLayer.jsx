...
const CARD_KIND_COMPONENTS = { checklist: ChecklistCard, embed: EmbedCard, flashcard: FlashcardCard, statcard: StatcardCard, stopwatch: StopwatchCard, table: TableCard, watermark: WatermarkCard };
