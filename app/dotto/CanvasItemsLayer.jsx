...
const CARD_KIND_COMPONENTS = { checklist: ChecklistCard, embed: EmbedCard, statcard: StatcardCard, stopwatch: StopwatchCard, title: TitleCard, watermark: WatermarkCard };
