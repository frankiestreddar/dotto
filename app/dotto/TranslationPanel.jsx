...
// original renderTranslationPanel — updateSearchDropdown (app/dotto/lib/aiAssistantSuggestions.ts)
// reads that inline style directly to decide whether #search-dropdown itself should be visible,
// so this has to keep setting it exactly as before, not hand that decision to React.
