...
export default function WatermarkCard({ it }) {
  ...
  return <div ref={ref} className="body watermark-text" data-placeholder="Type to trace..." dangerouslySetInnerHTML={{ __html: it.html || "" }} />;
}
