...
// (ExtensionsPanel.jsx) — dummy data for now (extensionsListStore, bridges.js, seeded with two
// placeholder entries), so there's nothing to actually refresh from Supabase yet. This function
