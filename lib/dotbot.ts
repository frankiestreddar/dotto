...
// a bare word (see generateMnemonicStoryAndImage in app/dotto/lib/mnemonicSearchMatching.ts —
// there's no separate dictionary lookup feeding this route pronunciation/definition ahead of
