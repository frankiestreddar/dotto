...
function getVoicesCached(): Promise<Voice[]> {
  if (!voicesPromise) {
...
async function pickVoiceForLocale(locale: string | undefined): Promise<string> {
...
export async function synthesizeSpeech(text: string, locale: string | undefined): Promise<Buffer> {
