...
export async function pixelateToSprite(imageBuffer, { width, height, pixelGridWidth, pixelGridHeight }) {
  const small = await sharp(imageBuffer).resize(pixelGridWidth, pixelGridHeight, { kernel: "lanczos3" }).toBuffer();
