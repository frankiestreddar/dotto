...
//
// app/dotto/lib/profileAchievementsPricing.ts (client-side call sites) can't import this
// server-only file directly, so calculateUserLevel's logic is deliberately duplicated there too,
// comment-linked back to this file as the canonical source. Keep the two in sync if the formula or
// LEVEL_NAMES ever change.
