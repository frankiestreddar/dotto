...
import { smoothPanTo } from './history-autosave.js';
...
import { expandWaypointCard, openFolder } from './waypoints-render-loop.js';

// Phase 4.3 split (was part of shared-canvases-outline.js, see PHASE4_ROADMAP.md) — the
// "outline-tree" concern: the canvas outline hierarchical builder inside the hamburger menu (and
// the "M" keyboard shortcut / rail-icon toggle that opens it), plus the small kind→icon mapping
// and hover-revealed row-actions markup shared with other sidebar list rows.
...
export { buildOutline, goToOutlineItem, goToOutlineSource, goToOutlineSourceRow, handleOutlineSearch, kindIconFile, kindIconHTML, rowActionsHTML, setOutlineActive, syncOutlineRows, toggleHamburgerMenu, toggleOutlineCollapse };
