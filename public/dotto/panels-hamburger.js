...
import { closeSourceAddMenu } from './source-buttons-cursor-mode.js';
    ...
    // #inbox-panel/#search-panel/#documents-panel/#sources-panel/#snippets-panel/#snippets2-panel/
    // #friends-panel/#settings-panel have no content/refresh logic of their own yet (see their own
    // comments, hamburger-stack.html) — no onOpen callback needed until that's designed.
    ...
    wireRailIcon('friends', appState.btnFriends, appState.friendsPanel, null);
    wireRailIcon('settings', appState.btnSettings, appState.settingsPanel, null);
